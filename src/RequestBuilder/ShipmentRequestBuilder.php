...
class ShipmentRequestBuilder implements ShipmentRequestBuilderInterface
{
	 ...
	 * @return void
	 */
	public function addInternationalDetail(
		$invoiceNumber,
		$invoiceDate,
		$placeOfIncoterm,
		$exportReasonType,
		...
		foreach ($exportItems as $exportItem) {
			$exportItemData = [
				'ItemNumber'                => $i,
				'GrossWeight'               => $exportItem['grossWeight'],
				'ManufacturingCountryCode'  => $exportItem['manufacturingCountryCode'],
				'QuantityUnitOfMeasurement' => $exportItem['unitOfMeasurement'],
				'Quantity'                  => $exportItem['quantity'],
				'UnitPrice'                 => $exportItem['unitPrice'],
				'ItemDescription'           => $exportItem['itemDescription'],
				'NetWeight'                 => $exportItem['netWeight'],
				'CommodityCode'             => $exportItem['commodityCode'],
			];

			$exportItemsData[] = $exportItemData;
			$i++;
		}
	...
	public function build()
	{
		...
		// Build international details
		if (isset($this->data['InternationlDetail'])) {
			$exportLineItems = [];

			foreach ($this->data['InternationlDetail']['ExportLineItems'] as $exportLineItem) {
				$exportLineItems[] = new ExportLineItem(
					$exportLineItem['GrossWeight'],
					$exportLineItem['ManufacturingCountryCode'],
					$exportLineItem['QuantityUnitOfMeasurement'],
					$exportLineItem['CommodityCode'],
					$exportLineItem['Quantity'],
					$exportLineItem['UnitPrice'],
					$exportLineItem['ItemDescription'],
					$exportLineItem['ItemNumber'],
					$exportLineItem['NetWeight']
				);
			}

			$internationalDetail = new InternationalDetail(
				$this->data['InternationlDetail']['InvoiceNumber'],
				$this->data['InternationlDetail']['InvoiceDate'],
				$this->data['InternationlDetail']['ExportReasonType'],
				$this->data['InternationlDetail']['PlaceOfIncoterm'],
				$this->data['InternationlDetail']['RecepientReference'],
				$exportLineItems
			);
		}
